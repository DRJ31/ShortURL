...
TEST(BaseConvertTest, Binary) {
    std::string str = BaseConvert<long>::decToBinary(7, 8);
    ASSERT_TRUE(str.compare(""));
    EXPECT_STREQ(str.data(), "00000111");
}

TEST(BaseConvertTest, Base64Encode) {
    std::string str1 = BaseConvert<std::string>::base64Encode("1234");
    std::string str2 = BaseConvert<std::string>::base64Encode("123");
    std::string str3 = BaseConvert<std::string>::base64Encode("12");
...
TEST(BaseConvertTest, Base64Decode) {
    std::string str1 = BaseConvert<std::string>::base64Decode("MTIzNA==");
    std::string str2 = BaseConvert<std::string>::base64Decode("MTIz");
    std::string str3 = BaseConvert<std::string>::base64Decode("MTI=");
    ASSERT_TRUE(str1.compare(""));
    ASSERT_TRUE(str2.compare(""));
    ASSERT_TRUE(str3.compare(""));
